...
# === GPIO SETUP ===
h = lgpio.gpiochip_open(0)  # เปิด GPIO chip (ใช้ chip0)
lgpio.gpio_claim_output(h, RELAY_PIN)  # ตั้งขา GPIO เป็น output
lgpio.gpio_write(h, RELAY_PIN, 1)  # ตั้งค่าเริ่มต้นเป็น HIGH (ปิด)
